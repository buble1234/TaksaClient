...
import no.cap.engine.shaders.ShaderManager;
...
public final class MsdfFont {
	...
	public static class Builder {
		...
		public Builder data(String dataFileName) {
			this.dataIdentifer = Identifier.of("nocap", "fonts/" + dataFileName + ".json");
			return this;
		}
		
		public Builder atlas(String atlasFileName) {
			this.atlasIdentifier = Identifier.of("nocap", "fonts/" + atlasFileName + ".png");
			return this;
		}
		
		public MsdfFont build() {
			FontData data = ShaderManager.fromJsonToInstance(this.dataIdentifer, FontData.class);
