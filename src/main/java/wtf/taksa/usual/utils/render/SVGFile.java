...
public class SVGFile implements Closeable {
    ...
    private void _redraw(float width, float height) {
        ...
        Taksa.LOGGER.debug("Drawing SVG to identifier {}:{}, dimensions are {}x{}", this.id.getNamespace(), this.id.getPath(), width, height);
        ...
        try {
            ...
            Taksa.LOGGER.error("Failed to render SVG", t);
