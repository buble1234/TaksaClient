 ...
 */
public class RadarShader {
    public static final RadarShader INSTANCE = new RadarShader();
    ...
    public void onShadersLoaded() {
        this.shader = ShaderManager.INSTANCE.getProgram(Shaders.RADAR);
        if (this.shader == null) {
            return;
        }
    ...
    public void use() {
        RenderSystem.setShader(ShaderManager.INSTANCE.getProgramSupplier(Shaders.RADAR));
    }
